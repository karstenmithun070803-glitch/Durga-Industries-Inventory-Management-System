              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  {visible.map((t, i) => (
                    <tr
                      key={t.id}
                      className={`group border-t border-slate-200 cursor-pointer ${i === focusedIdx ? "ring-1 ring-inset ring-blue-500 bg-blue-50" : !t.is_active ? "opacity-50 bg-slate-50 hover:bg-slate-100" : "hover:bg-rowhover hover:text-slate-900"}`}
                      onClick={() => startEdit(t)}
                    >
