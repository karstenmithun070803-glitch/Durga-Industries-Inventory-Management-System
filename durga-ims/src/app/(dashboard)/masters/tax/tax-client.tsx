  ...
  return (
    <>
                      ...
                      <td className="px-4 py-2.5">
                        <div className="flex gap-1">
                          ...
                          <Button variant="ghost" size="icon" className="h-7 w-7 text-red-500 hover:bg-red-50"
                            onClick={() => setDeletingId(t.id)} disabled={isPending}>
      ...
      <ConfirmDialog
        ...
        description="This will soft-delete the tax rate. Materials and transactions using this rate will be unaffected."
        onConfirm={() => {
